...
- **Upstream DNS provider** — the server Pi-hole itself uses to resolve queries it doesn't block. Cloudflare (`1.1.1.1`), Google (`8.8.8.8`), and Quad9 (`9.9.9.9`) are all solid choices. I use Cloudflare and Quad9 as a backup. You can change this later.
