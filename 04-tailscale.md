...
```bash
ssh your-username@your-pi's-tailscale-ipv4
```
...
- `--https=PORT` is the port Tailscale uses to forward your service on the tailnet.
...
Serve rules persist across reboots.
